                    ...
                    <FormikField
                      ...
                      render={({ field }) => (
                        ...
                        >
                          ...
                          <Option value="Conferecence Pronceendings">
                ...
                <Col span={24}>
                  ...
                  >
                    <FormikField
                      name="title"
                      render={({ field }) => (
                        <Input {...field} name="title" placeholder="Title..." />
                      )}
                    />
                  </FormItem>
                </Col>
                <Col span={24}>
                  ...
                  >
                    <FormikField
                      name="abstract"
                      render={({ field }) => (
                        <TextArea {...field} name="abstract" placeholder="Abstract..." autosize={{ minRows: 2, maxRows: 6 }} />
                      )}
                    />
                  </FormItem>
                </Col>
